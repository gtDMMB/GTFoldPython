...
#include "subopt_traceback_cinclude.h"

#ifdef __cplusplus
extern "C" {
     void push_to_gstack(ps_stack_t & gs, const ps_t& v);
     ss_map_t subopt_traceback(int len, int gap, const char *suboptFile, int writeToFile, 
     ...
     void subopt_traceVM(int i, int j, ps_t & ps, ps_stack_t & gs);
     void subopt_traceWM(int i, int j, ps_t &  ps, ps_stack_t & gs);
     void subopt_traceWMPrime(int i, int j, ps_t &  ps, ps_stack_t & gs);
