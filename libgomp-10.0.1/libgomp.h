...
/* This file contains data types and function declarations that are not
   ...
   that are part of the external externally_visible ABI, and the lower case prefix "gomp"
...
#include "gcc-include/gomp-constants.h"
...
extern __attribute__(()) void *gomp_malloc (size_t) __attribute__((malloc));
extern __attribute__(()) void *gomp_malloc_cleared (size_t) __attribute__((malloc));
extern __attribute__(()) void *gomp_realloc (void *, size_t);
extern __attribute__(()) void *gomp_aligned_alloc (size_t, size_t)
  __attribute__((malloc, alloc_size (2)));
extern __attribute__(()) void gomp_aligned_free (void *);
...
extern __attribute__(()) void gomp_vdebug (int, const char *, va_list);
extern __attribute__(()) void gomp_debug (int, const char *, ...)
...
extern __attribute__(()) void gomp_verror (const char *, va_list);
extern __attribute__(()) void gomp_error (const char *, ...)
	__attribute__ ((format (printf, 1, 2)));
extern __attribute__(()) void gomp_vfatal (const char *, va_list)
	__attribute__ ((noreturn));
extern __attribute__(()) void gomp_fatal (const char *, ...)
...
extern __attribute__(()) struct gomp_task_icv gomp_global_icv;
#ifndef HAVE_SYNC_BUILTINS
extern __attribute__(()) gomp_mutex_t gomp_managed_threads_lock;
#endif
extern __attribute__(()) unsigned long gomp_max_active_levels_var;
extern __attribute__(()) bool gomp_cancel_var;
extern __attribute__(()) int gomp_max_task_priority_var;
extern __attribute__(()) unsigned long long gomp_spin_count_var, gomp_throttled_spin_count_var;
extern __attribute__(()) unsigned long gomp_available_cpus, gomp_managed_threads;
extern __attribute__(()) unsigned long *gomp_nthreads_var_list, gomp_nthreads_var_list_len;
extern __attribute__(()) char *gomp_bind_var_list;
extern __attribute__(()) unsigned long gomp_bind_var_list_len;
extern __attribute__(()) void **gomp_places_list;
extern __attribute__(()) unsigned long gomp_places_list_len;
extern __attribute__(()) unsigned int gomp_num_teams_var;
extern __attribute__(()) int gomp_debug_var;
extern __attribute__(()) bool gomp_display_affinity_var;
extern __attribute__(()) char *gomp_affinity_format_var;
extern __attribute__(()) size_t gomp_affinity_format_len;
extern __attribute__(()) int goacc_device_num;
extern __attribute__(()) char *goacc_device_type;
extern __attribute__(()) int goacc_default_dims[GOMP_DIM_MAX];
...
extern __attribute__(()) struct gomp_thread *nvptx_thrs __attribute__((shared));
...
typedef struct {
     gomp_thread gomp_tls_data;
} ___emutls_v_TYPE;
extern ___emutls_v_TYPE ___emutls_v; //__attribute__((visibility("default")));

#else
extern __attribute__(()) pthread_key_t gomp_tls_key;
static inline struct gomp_thread *gomp_thread (void)
{
...
extern __attribute__(()) struct gomp_task_icv *gomp_new_icv (void);
...
extern __attribute__(()) pthread_attr_t gomp_thread_attr;

extern __attribute__(()) pthread_key_t gomp_thread_destructor;
#endif
...
extern __attribute__(()) void gomp_init_affinity (void);
#ifdef LIBGOMP_USE_PTHREADS
extern __attribute__(()) void gomp_init_thread_affinity (pthread_attr_t *, unsigned int);
#endif
extern __attribute__(()) void **gomp_affinity_alloc (unsigned long, bool);
extern __attribute__(()) void gomp_affinity_init_place (void *);
extern __attribute__(()) bool gomp_affinity_add_cpus (void *, unsigned long, unsigned long,
				    long, bool);
extern __attribute__(()) bool gomp_affinity_remove_cpu (void *, unsigned long);
extern __attribute__(()) bool gomp_affinity_copy_place (void *, void *, long);
extern __attribute__(()) bool gomp_affinity_same_place (void *, void *);
extern __attribute__(()) bool gomp_affinity_finalize_place_list (bool);
extern __attribute__(()) bool gomp_affinity_init_level (int, unsigned long, bool);
extern __attribute__(()) void gomp_affinity_print_place (void *);
extern __attribute__(()) void gomp_get_place_proc_ids_8 (int, int64_t *);
extern __attribute__(()) void gomp_display_affinity_place (char *, size_t, size_t *, int);

/* affinity-fmt.c */

extern __attribute__(()) bool gomp_print_string (const char *str, size_t len);
extern __attribute__(()) void gomp_set_affinity_format (const char *, size_t);
extern __attribute__(()) void gomp_display_string (char *, size_t, size_t *, const char *,
				 size_t);
#ifdef LIBGOMP_USE_PTHREADS
...
#endif
extern __attribute__(()) size_t gomp_display_affinity (char *, size_t, const char *,
				     gomp_thread_handle,
				     struct gomp_team_state *, unsigned int);
extern __attribute__(()) void gomp_display_affinity_thread (gomp_thread_handle,
					  struct gomp_team_state *,
					  unsigned int) __attribute__((cold));

/* iter.c */

extern __attribute__(()) int gomp_iter_static_next (long *, long *);
extern __attribute__(()) bool gomp_iter_dynamic_next_locked (long *, long *);
extern __attribute__(()) bool gomp_iter_guided_next_locked (long *, long *);

#ifdef HAVE_SYNC_BUILTINS
extern __attribute__(()) bool gomp_iter_dynamic_next (long *, long *);
extern __attribute__(()) bool gomp_iter_guided_next (long *, long *);
#endif

/* iter_ull.c */

extern __attribute__(()) int gomp_iter_ull_static_next (unsigned long long *,
				      unsigned long long *);
extern __attribute__(()) bool gomp_iter_ull_dynamic_next_locked (unsigned long long *,
					       unsigned long long *);
extern __attribute__(()) bool gomp_iter_ull_guided_next_locked (unsigned long long *,
					      unsigned long long *);

#if defined HAVE_SYNC_BUILTINS && defined __LP64__
extern __attribute__(()) bool gomp_iter_ull_dynamic_next (unsigned long long *,
					unsigned long long *);
extern __attribute__(()) bool gomp_iter_ull_guided_next (unsigned long long *,
				       unsigned long long *);
#endif

/* ordered.c */

extern __attribute__(()) void gomp_ordered_first (void);
extern __attribute__(()) void gomp_ordered_last (void);
extern __attribute__(()) void gomp_ordered_next (void);
extern __attribute__(()) void gomp_ordered_static_init (void);
extern __attribute__(()) void gomp_ordered_static_next (void);
extern __attribute__(()) void gomp_ordered_sync (void);
extern __attribute__(()) void gomp_doacross_init (unsigned, long *, long, size_t);
extern __attribute__(()) void gomp_doacross_ull_init (unsigned, unsigned long long *,
				    unsigned long long, size_t);

/* parallel.c */

extern __attribute__(()) unsigned gomp_resolve_num_threads (unsigned, unsigned);

/* proc.c (in config/) */

extern __attribute__(()) void gomp_init_num_threads (void);
extern __attribute__(()) unsigned gomp_dynamic_max_threads (void);

/* task.c */

extern __attribute__(()) void gomp_init_task (struct gomp_task *, struct gomp_task *,
			    struct gomp_task_icv *);
extern __attribute__(()) void gomp_end_task (void);
extern __attribute__(()) void gomp_barrier_handle_tasks (gomp_barrier_state_t);
extern __attribute__(()) void gomp_task_maybe_wait_for_dependencies (void **);
extern __attribute__(()) bool gomp_create_target_task (struct gomp_device_descr *,
				     void (*) (void *), size_t, void **,
				     size_t *, unsigned short *, unsigned int,
				     void **, void **,
				     enum gomp_target_task_state);
extern __attribute__(()) struct gomp_taskgroup *gomp_parallel_reduction_register (uintptr_t *,
								unsigned);
extern __attribute__(()) void gomp_workshare_taskgroup_start (void);
extern __attribute__(()) void gomp_workshare_task_reduction_register (uintptr_t *, uintptr_t *);
...
extern __attribute__(()) struct gomp_team *gomp_new_team (unsigned);
extern __attribute__(()) void gomp_team_start (void (*) (void *), void *, unsigned,
			     unsigned, struct gomp_team *,
			     struct gomp_taskgroup *);
extern __attribute__(()) void gomp_team_end (void);
extern __attribute__(()) void gomp_free_thread (void *);
extern __attribute__(()) int gomp_pause_host (void);

/* target.c */

extern __attribute__(()) void gomp_init_targets_once (void);
extern __attribute__(()) int gomp_get_num_devices (void);
extern __attribute__(()) bool gomp_target_task_fn (void *);
...
extern __attribute__(()) void gomp_acc_declare_allocate (bool, size_t, void **, size_t *,
				       unsigned short *);
struct gomp_coalesce_buf;
extern __attribute__(()) void gomp_copy_host2dev (struct gomp_device_descr *,
				struct goacc_asyncqueue *, void *, const void *,
				size_t, struct gomp_coalesce_buf *);
extern __attribute__(()) void gomp_copy_dev2host (struct gomp_device_descr *,
				struct goacc_asyncqueue *, void *, const void *,
				size_t);
extern __attribute__(()) uintptr_t gomp_map_val (struct target_mem_desc *, void **, size_t);
extern __attribute__(()) void gomp_attach_pointer (struct gomp_device_descr *,
				 struct goacc_asyncqueue *, splay_tree,
				 splay_tree_key, uintptr_t, size_t,
				 struct gomp_coalesce_buf *);
extern __attribute__(()) void gomp_detach_pointer (struct gomp_device_descr *,
				 struct goacc_asyncqueue *, splay_tree_key,
				 uintptr_t, bool, struct gomp_coalesce_buf *);

extern __attribute__(()) struct target_mem_desc *gomp_map_vars (struct gomp_device_descr *,
					      size_t, void **, void **,
					      size_t *, void *, bool,
					      enum gomp_map_vars_kind);
extern __attribute__(()) struct target_mem_desc *gomp_map_vars_async (struct gomp_device_descr *,
						    struct goacc_asyncqueue *,
						    size_t, void **, void **,
						    size_t *, void *, bool,
						    enum gomp_map_vars_kind);
extern __attribute__(()) void gomp_unmap_vars (struct target_mem_desc *, bool);
extern __attribute__(()) void gomp_unmap_vars_async (struct target_mem_desc *, bool,
				   struct goacc_asyncqueue *);
extern __attribute__(()) void gomp_init_device (struct gomp_device_descr *);
extern __attribute__(()) bool gomp_fini_device (struct gomp_device_descr *);
extern __attribute__(()) void gomp_unload_device (struct gomp_device_descr *);
extern __attribute__(()) bool gomp_remove_var (struct gomp_device_descr *, splay_tree_key);
extern __attribute__(()) void gomp_remove_var_async (struct gomp_device_descr *, splay_tree_key,
				   struct goacc_asyncqueue *);

/* work.c */

extern __attribute__(()) void gomp_init_work_share (struct gomp_work_share *, size_t, unsigned);
extern __attribute__(()) void gomp_fini_work_share (struct gomp_work_share *);
extern __attribute__(()) bool gomp_work_share_start (size_t);
extern __attribute__(()) void gomp_work_share_end (void);
extern __attribute__(()) bool gomp_work_share_end_cancel (void);
extern __attribute__(()) void gomp_work_share_end_nowait (void);
...
extern __attribute__(()) void gomp_init_lock_30 (omp_lock_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_destroy_lock_30 (omp_lock_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_set_lock_30 (omp_lock_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_unset_lock_30 (omp_lock_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) int gomp_test_lock_30 (omp_lock_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_init_nest_lock_30 (omp_nest_lock_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_destroy_nest_lock_30 (omp_nest_lock_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_set_nest_lock_30 (omp_nest_lock_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_unset_nest_lock_30 (omp_nest_lock_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) int gomp_test_nest_lock_30 (omp_nest_lock_t *) __attribute__(()) __GOMP_NOTHROW;

extern __attribute__(()) void gomp_init_lock_25 (omp_lock_25_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_destroy_lock_25 (omp_lock_25_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_set_lock_25 (omp_lock_25_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_unset_lock_25 (omp_lock_25_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) int gomp_test_lock_25 (omp_lock_25_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_init_nest_lock_25 (omp_nest_lock_25_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_destroy_nest_lock_25 (omp_nest_lock_25_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_set_nest_lock_25 (omp_nest_lock_25_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) void gomp_unset_nest_lock_25 (omp_nest_lock_25_t *) __attribute__(()) __GOMP_NOTHROW;
extern __attribute__(()) int gomp_test_nest_lock_25 (omp_nest_lock_25_t *) __attribute__(()) __GOMP_NOTHROW;
...
*/
# define ialias(fn) \
  extern __typeof (fn) gomp_ialias_##fn __attribute__(()) \
	  __attribute__ ((alias (#fn))) attribute_copy (fn);
/*
# define ialias_redirect(fn) \
  extern __typeof (fn) fn __asm__ (ialias_ulp "gomp_ialias_" #fn) attribute_hidden;
*/
# define ialias_redirect(fn) \
  extern __attribute__(()) __typeof (fn) fn __asm__ (ialias_ulp "gomp_ialias_" #fn);
