...
extern __attribute__(()) void acc_prof_register (acc_event_t, acc_prof_callback,
			       acc_register_t) __GOACC_NOTHROW;
extern __attribute__(()) void acc_prof_unregister (acc_event_t, acc_prof_callback,
				 acc_register_t) __GOACC_NOTHROW;
typedef void (*acc_query_fn) ();
typedef acc_query_fn (*acc_prof_lookup_func) (const char *);
extern __attribute__(()) acc_query_fn acc_prof_lookup (const char *) __GOACC_NOTHROW;
...
extern __attribute__(()) void acc_register_library (acc_prof_reg, acc_prof_reg,
