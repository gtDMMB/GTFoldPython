...
extern __attribute__(()) splay_tree_key splay_tree_lookup (splay_tree, splay_tree_key);
extern __attribute__(()) void splay_tree_insert (splay_tree, splay_tree_node);
extern __attribute__(()) void splay_tree_remove (splay_tree, splay_tree_key);
extern __attribute__(()) void splay_tree_foreach (splay_tree, splay_tree_callback, void *);
#else  /* splay_tree_c */
#  ifdef splay_tree_prefix
