...
extern __attribute__(()) bool priority_queue_task_in_queue_p (enum priority_queue_type,
					    struct priority_queue *,
					    struct gomp_task *);
extern __attribute__(()) void priority_queue_dump (enum priority_queue_type,
				 struct priority_queue *);
extern __attribute__(()) void priority_queue_verify (enum priority_queue_type,
				   struct priority_queue *, bool);
extern __attribute__(()) void priority_tree_remove (enum priority_queue_type,
				  struct priority_queue *,
				  struct priority_node *);
extern __attribute__(()) struct gomp_task *priority_tree_next_task (enum priority_queue_type,
						  struct priority_queue *,
						  enum priority_queue_type,
						  struct priority_queue *,
						  bool *);
