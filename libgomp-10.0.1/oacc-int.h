...
/* This file contains data types and function declarations that are not
   ...
   that are part of the external externally_visible ABI, and the lower case prefix "goacc"
...
#else
extern __attribute__(()) pthread_key_t goacc_tls_key;
static inline struct goacc_thread *
goacc_thread (void)
{
...
extern __attribute__(()) bool goacc_prof_enabled;
