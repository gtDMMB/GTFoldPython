...
# undef LIBGOMP_GNU_SYMBOL_VERSIONING // Added: MDS -- 2020.01.23
...
# define gomp_ialias_omp_init_lock          omp_init_lock
# define gomp_ialias_omp_init_nest_lock     omp_init_nest_lock
# define gomp_ialias_omp_destroy_lock       omp_destroy_lock
# define gomp_ialias_omp_destroy_nest_lock  omp_destroy_nest_lock
# define gomp_ialias_omp_set_lock           omp_set_lock
# define gomp_ialias_omp_set_nest_lock      omp_set_nest_lock
# define gomp_ialias_omp_unset_lock         omp_unset_lock
# define gomp_ialias_omp_unset_nest_lock    omp_unset_nest_lock
# define gomp_ialias_omp_test_lock          omp_test_lock
# define gomp_ialias_omp_test_nest_lock     omp_test_nest_lock

#if !defined(__nvptx__) && !defined(__AMDCGN__) && \
        (defined(HAVE_TLS) || defined(USE_EMUTLS))
___emutls_v_TYPE ___emutls_v = (___emutls_v_TYPE) 0L;
#endif
